                    ...
                    <div class="iq-card-body pb-0">
                        <div class="description-contens align-items-top row">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-12">
                                                <ul id="description-slider" class="list-inline p-0 m-0  d-flex align-items-center">
                                                    <li>
                                                        <img src="/assets/img-buku/<?= $buku_macatongsir['photo'] ?>" class="img-fluid w-100 rounded" alt="asu">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-8">
                                <div class="iq-card-transparent iq-card-block iq-card-stretch iq-card-height">
                                    <div class="iq-card-body p-0">
                                        <h3 class="mb-3"><?= $buku_macatongsir['judul'] ?></h3>
                                        <div class="price d-flex align-items-center font-weight-500 mb-2">
                                            <span class="font-size-24 text-dark">ISBN & ISSN - <?= $buku_macatongsir['isbn_issn'] ?></span>
                                        </div>
                                        <div class="mb-3 d-block">
                                            <span class="font-size-20 text-warning">
                                                <?= $buku_macatongsir['bahasa'] ?>
                                            </span>
                                        </div>
                                        <div class="mb-3">
                                            <?php if (session()->get('email')) : ?>
                                                <form action="/pengguna/simpan_bookmarks/<?= $buku_macatongsir['kode_buku'] ?>" method="post">
                                                    <?= csrf_field() ?>
                                        ...
                                        <span class="text-dark pb-4 d-block"><?= $buku_macatongsir['deskripsi'] ?></span>
                                        <div class="text-primary mb-4 iq-border-bottom">Author: <span class="text-body"><?= $buku_macatongsir['author'] ?></span></div>
