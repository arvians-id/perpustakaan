                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="left" valign="top" style="font-size: 16px; padding: 0 50px">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" valign="middle" style="padding: 0; ">
                                                                    ...
                                                                    <h1 style="font-size: 24px; font-weight: 600; margin: 0; text-align: center">Proses Registrasi Telah Berhasil</h1>
                                                    ...
                                                    <p style="margin: 0">Kami telah menerima pendaftaran akun di <a href="<?= base_url() ?>" style="text-decoration: none; color: #00a4bd;">Macatongsir.</a> Segera aktivasi email kamu ditombol bawah ini ya,</p>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 0; height: 50px; width: 100%; min-width: 100%; line-height: 0;">
                                                        <tbody>
                                                            <tr>
                                                                <td height="50"><span style="-webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; color: transparent; background: none; user-select: none; -moz-user-select: none; -ms-user-select:none; -webkit-user-select:none; text-overflow: ellipsis; opacity: 0; width:100%; min-width: 100%; height:1; overflow:hidden; margin: -1px 0 0 0; padding:0; font-size: 0;"> &nbsp;</span></td>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center" style="border-radius: 3px;" bgcolor="#425b76" width="auto"><a href="<?= base_url() . '/masuk/verifikasi?email=' . $email . '&token=' . urlencode($token) ?>" target="_blank" style="border: 1px solid #425b76; border-radius: 3px; color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 500; line-height: 1; padding: 12px 20px; text-decoration: none; width: auto; min-width: 170px; white-space: nowrap; ">Aktivasi Sekarang</a></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </td>
                                                    ...
                                                    <p style="font-size: 14px; margin: 0">Aktivasi email ini akan kadaluarsa setelah 15 menit, jadi pastikan kamu segera aktivasi emailmu ya. Perlu bantuan? <a href="mailto:macatongsir.id@gmail.com" style="text-decoration: none; color: #00a4bd;">Hubungi Kami</a></p>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 0; height: 50px; width: 100%; min-width: 100%; line-height: 0;">
                                                        <tbody>
                                                            <tr>
                                                                <td height="50"><span style="-webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; color: transparent; background: none; user-select: none; -moz-user-select: none; -ms-user-select:none; -webkit-user-select:none; text-overflow: ellipsis; opacity: 0; width:100%; min-width: 100%; height:1; overflow:hidden; margin: -1px 0 0 0; padding:0; font-size: 0;"> &nbsp;</span></td>
