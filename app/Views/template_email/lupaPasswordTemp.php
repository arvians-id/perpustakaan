                            ...
                            <tr>
                                <td align="center" valign="top" width="100%" style="width: 100%; min-width: 100%;">
                                    <table cellpadding="12" border="0" cellspacing="0" width="100%" bgcolor="#ff7a59" style="width: 100%; min-width:100%;">
                                        <tbody>
                                            <tr>
                                                <td align="center" valign="middle" width="100%" style="background: #425b76"><img src="<?= base_url() . '/assets/banner-logo/logos.png' ?>" alt="Satu Pustaka" width="120" height="35" style="width: 120px; height: 35px; vertical-align: middle; clear: both; width: auto; max-width: 100%;"><span style="-webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; color: transparent; background: none; user-select: none; -moz-user-select: none; -ms-user-select:none; -webkit-user-select:none; text-overflow: ellipsis; opacity: 0; width:100%; min-width: 100%; height:1; overflow:hidden; margin: -1px 0 0 0; padding:0; font-size: 0;"> &nbsp;</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="left" valign="top" style="font-size: 16px; padding: 0 50px">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" valign="middle" style="padding: 0; ">
                                                                    ...
                                                                    <h1 style="font-size: 24px; font-weight: 600; margin: 0; text-align: center">Reset Ulang Password Anda</h1>
                                                    ...
                                                    <p style="margin: 0">Hai Pengguna Macatongsir,</p><br>
                                                    <p style="margin: 0">Kami telah menerima permintaan untuk reset passwowrd anda di <a href="<?= base_url() ?>" style="text-decoration: none; color: #00a4bd;">Macatongsir.</a> Untuk langkah selanjutnya klik tombol dibawah ini ya,</p>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 0; height: 50px; width: 100%; min-width: 100%; line-height: 0;">
                                                        <tbody>
                                                            <tr>
                                                                <td height="50"><span style="-webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; color: transparent; background: none; user-select: none; -moz-user-select: none; -ms-user-select:none; -webkit-user-select:none; text-overflow: ellipsis; opacity: 0; width:100%; min-width: 100%; height:1; overflow:hidden; margin: -1px 0 0 0; padding:0; font-size: 0;"> &nbsp;</span></td>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center" style="border-radius: 3px;" bgcolor="#425b76" width="auto"><a href="<?= base_url() . '/masuk/resetpassword?email=' . $email . '&token=' . urlencode($token) ?>" target="_blank" style="border: 1px solid #425b76; border-radius: 3px; color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 500; line-height: 1; padding: 12px 20px; text-decoration: none; width: auto; min-width: 170px; white-space: nowrap; ">Reset Password</a></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </td>
                                                    ...
                                                    <p style="font-size: 14px; margin: 0">Reset Password ini akan kadaluarsa setelah satu 15 menit, jadi pastikan kamu segera reset password emailmu ya. Perlu bantuan? <a href="mailto:macatongsir.id@gmail.com" style="text-decoration: none; color: #00a4bd;">Hubungi Kami</a></p>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 0; height: 50px; width: 100%; min-width: 100%; line-height: 0;">
                                                        <tbody>
                                                            <tr>
                                                                <td height="50"><span style="-webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; color: transparent; background: none; user-select: none; -moz-user-select: none; -ms-user-select:none; -webkit-user-select:none; text-overflow: ellipsis; opacity: 0; width:100%; min-width: 100%; height:1; overflow:hidden; margin: -1px 0 0 0; padding:0; font-size: 0;"> &nbsp;</span></td>
                                    ...
                                    <table id="footer" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" bgcolor="#f5f8fa" style="width: 100%; min-width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td align="center" valign="top">
                                                    <table cellpadding="0" border="0" cellspacing="0" width="100%" style="color: #425b76; font-size: 14px; width: 100%; margin: initial; min-width: 100%; line-height: 24px">
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" valign="middle" style="padding: 20px 0 65px; "><a href=""></a><span>&nbsp;</span>
                                                                    <p style="font-size: 12px; color: #516f90">TBM Macatongsir<br>Kp Gentong Pasir RT 04/01<br>Kecamatan Sukaraja Kabupaten Sukabumi</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
